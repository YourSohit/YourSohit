...
class config:
    AUTH_USERS = [1451257129,829259422,5566445571,1447495324,579974245]
    ADMIN_USERS = [5566445571,579974245]
...
def multi_rip(client, message, streamUrl, channel, recordingDuration, language, ripType, ripQuality, fileTitle):
    ...
    filename = f'[MX NITRO] {channel} - {fileTitle} - {ind_time} [{ripQuality}] [x264] {ripType} [{language}].mkv'
